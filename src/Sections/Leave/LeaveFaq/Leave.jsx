...
import LeaveFaqStyleWrapper from "./LeaveFaq.style";
import SectionTitle from "../../../Components/SectionTitle/SectionTitle";
import { LeaveFaqData } from "../../../assets/data/leave/LeaveFaqData";
...
const LeaveFaq = () => {
  ...
  return (
    <LeaveFaqStyleWrapper className="faq-section-4 app-faq-section">
    ...
    </LeaveFaqStyleWrapper>
  );
};

export default LeaveFaq;
