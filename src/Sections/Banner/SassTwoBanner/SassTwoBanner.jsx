...
import sassDashboardImg from "../../../assets/images/sass2/sass-hero.png";
            ...
            <div className="col-lg-6">
              <ScrollAnimate delay={200}>
                <div className="sass-banner-text">
                  <h1>Empower Your HR Management With Centa</h1>
                  <p>
                    Run HR like a pro — automate workflows, track attendance in
                    real-time, and manage your team from one smart, AI-powered
                    platform.
                  </p>
