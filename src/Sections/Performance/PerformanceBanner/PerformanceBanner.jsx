...
import index5BannerImg from "../../../assets/images/performance/hero-image.png";
import PerformanceBannerStyle from "./PerformanceBanner.style";

const PerformanceBanner = () => {
  const [sassOneHeadline] = useTypingHeadlines(
    ["goals", "360° Feedback", "reviews"],
    {
  ...
  return (
    <PerformanceBannerStyle className="hero-section-index5">
          ...
          <ScrollAnimate delay={200}>
            <div className="v5banner-text">
              ...
              <p className="text-white">
                Set clear goals, enable continuous feedback, and run structured
                reviews that empower growth. Drive employee engagement and align
