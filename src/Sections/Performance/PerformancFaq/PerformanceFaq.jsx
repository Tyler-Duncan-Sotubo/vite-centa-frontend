...
import PerformanceFaqStyleWrapper from "./PerformanceFaq.style";
import SectionTitle from "../../../Components/SectionTitle/SectionTitle";
import { PerformanceFaqData } from "../../../assets/data/performance/PerformanceFaqData";
...
const PerformanceFaq = () => {
  ...
  return (
    <PerformanceFaqStyleWrapper className="faq-section-4 app-faq-section">
            ...
            <ScrollAnimate delay={250}>
              <div className="faq-section-4-tab">
                <div
                  ...
                  id="accordionExample"
                >
                  {PerformanceFaqData.map((item, index) => (
