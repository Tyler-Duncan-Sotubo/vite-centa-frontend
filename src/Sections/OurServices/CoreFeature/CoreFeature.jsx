                ...
                <TitleStyleWrapper>
                  <div className="section-title">
                    ...
                    <h2 className="title xl-mb-40 md-mb-20">
                      Smart HR Solutions - Powering People Growth
                    </h2>
                    <p>
                      From payroll automation to performance tracking and
                      employee self-service, CentaHR delivers everything your
                      business needs to simplify HR operations, stay compliant,
