              ...
              <ScrollAnimate delay={200}>
                <TitleStyleWrapper>
                  <div className="section-title">
                    ...
                    <h2 className="title">
                      Powering HR Innovation <br />
                      &amp; Payroll Excellence
                    </h2>
                    <p>
                      CentaHR combines modern technology with deep HR expertise
                      to help businesses streamline processes, stay compliant,
                      and empower their employees. From payroll automation to
                      performance tracking, we deliver the tools your team needs
                      to grow.
                    </p>
                  </div>
                </TitleStyleWrapper>
