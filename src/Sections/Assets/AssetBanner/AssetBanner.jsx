...
import index5BannerImg from "../../../assets/images/assets/index-banner.png";
import AssetBannerStyle from "./AssetBanner.style";

const AssetBanner = () => {
  const [sassOneHeadline] = useTypingHeadlines(
    ["Assets", "laptops", "vehicles"],
    {
  ...
  return (
    <AssetBannerStyle className="hero-section-index5">
          ...
          <ScrollAnimate delay={200}>
            <div className="v5banner-text">
              ...
              <p className="text-white">
                Track laptops, vehicles, and equipment from assignment to
                retirement. Automate depreciation, repairs, and ownership
                transfer — all in one centralized system.
              </p>
            </div>
          </ScrollAnimate>
        </div>
