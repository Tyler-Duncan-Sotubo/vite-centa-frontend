...
const HappyCustomersStyle = styled.section`
  ...
  position: relative;
  z-index: 0;
  isolation: isolate; /* contain stacking to this section */
  overflow: hidden; /* prevent bg from bleeding outside */

  .happy-customers-bg {
    position: absolute;
    z-index: 0; /* behind content but within this section */
    width: 100%;
    bottom: 0px;
    left: 0px;
    ...
    .happy-customers-bg-img {
      width: 100%;
      object-fit: cover;
      height: 100%; /* avoid huge fixed heights */
    }
  ...
  @media screen and (max-width: 1199px) {
    ...
    .happy-customers-bg .happy-customers-bg-img {
      height: 100%;
      max-height: 900px; /* cap on large tablets */
    }
  }
  ...
  @media screen and (max-width: 767px) {
    ...
    .happy-customers-bg .happy-customers-bg-img {
      height: 100%;
      max-height: 700px; /* cap on mobile */
    }
  }

  @media screen and (max-width: 575px) {
    /* optional extra rules here if needed */
  }
