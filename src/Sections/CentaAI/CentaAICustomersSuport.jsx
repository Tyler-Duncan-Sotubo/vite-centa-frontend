...
import CentaAICustomersSuportStyle from "./CentaAICustomersSuport.style";
import { suportCardData } from "./ChatbotCustomersSuportData";
import ScrollAnimate from "../../Components/ScrollAnimate";

const CentaAICustomersSuport = () => {
  useEffect(() => {
    const handleScroll = () => {
  ...
  return (
    <CentaAICustomersSuportStyle className="chatbot-customers-suport-sectoin z-index-3">
          ...
          {suportCardData.map((card, index) => (
            <div className={`col-md-6`} key={index}>
              <ScrollAnimate delay={card.delay}>
                <div
                  className={`chatbot-customers-suport-card ${card.cardClassName}`}
                >
    ...
    </CentaAICustomersSuportStyle>
  );
};

export default CentaAICustomersSuport;
